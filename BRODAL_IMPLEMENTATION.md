...
The current Brodal heap implementation is a **simplified version** that
provides correct behavior but does not fully implement all the mechanisms
required for optimal worst-case bounds.
...
This complexity, combined with high constant factors, makes Brodal heaps
rarely used in practice despite optimal theoretical bounds.
